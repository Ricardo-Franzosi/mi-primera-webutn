...
def shell(title, eyebrow, intro, body, chapter_number, prev_item=None, next_item=None):
    nav = []
    if prev_item:
...
{HEADER}
<main class="shell" id="contenido"><section class="page-hero chapter-hero"><p class="eyebrow">Antártida · Capítulo {chapter_number:02d} de {len(SECTIONS)} · {eyebrow}</p><h1>{title}</h1><p class="lead">{intro}</p></section>
...
def main():
    ...
    for i, (slug, title, _, dates, intro) in enumerate(SECTIONS):
        ...
        (OUT / f"{slug}.html").write_text(shell(title, dates, intro, chunk, i+1, prev_item, next_item), encoding="utf-8")
    ...
    ant_index = f'''<!DOCTYPE html><html lang="es"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1.0"><meta name="description" content="Etapa antártica de la expedición del Atlantis."><meta name="theme-color" content="#0b3440"><title>Antártida · Francho y el Atlantis</title><link rel="stylesheet" href="../../../css/styles.css"><link rel="stylesheet" href="../../../css/bitacora.css"><link rel="icon" type="image/svg+xml" href="../../../assets/favicon.svg"></head><body><a class="skip-link" href="#contenido">Saltar al contenido</a>
{HEADER}
<main class="shell" id="contenido"><section class="page-hero logbook-hero"><p class="eyebrow">Etapa 05 · Antártida</p><h1>Del Drake a las Islas Melchior</h1><p class="lead">La última entrada del blog original contiene un diario completo del tramo antártico. Aquí se presenta en cinco capítulos para facilitar la lectura, sin reescribir el relato.</p><div class="logbook-meta"><span>15 de diciembre de 2021 – 7 de enero de 2022</span><span>5 capítulos</span><span>Texto original</span></div></section>
<section class="antarctic-feature"><img src="../../../assets/images/Canal%20Murature%20Islas%20Melchior.JPG" alt="Tripulación antártica en Canal Murature"><div><p class="eyebrow">Archipiélago de las Islas Melchior</p><h2>Canal Murature</h2><p>La tripulación en uno de los fondeos de la etapa antártica, vinculada ahora al tramo exacto de la bitácora donde se narra la estadía en las Islas Melchior.</p></div></section>
<section class="antarctic-chapters-heading"><p class="eyebrow">Diario de navegación</p><h2>Cinco capítulos para recorrer la etapa antártica</h2></section><section class="timeline-grid antarctic-grid">{cards}</section>
<section class="logbook-note"><p class="eyebrow">Archivo original</p><h2>La entrada completa también se conserva</h2><p>La publicación íntegra sigue disponible como una sola entrada tanto en Blogger como dentro del archivo original de esta web.</p><p><a class="text-link" href="../drake-antartida-y-60-rugientes.html">Leer la entrada completa →</a></p></section></main>
<footer class="site-footer"><div class="shell footer-inner"><div><strong>Francho y el Atlantis</strong><p>Bitácora personal de navegación.</p></div><div class="footer-links"><a href="../index.html">Bitácora</a><a href="../../gallery.html">Galería</a></div></div></footer></body></html>'''
    ...
    extra = '''\n.chapter-photo-feature{margin:0 0 2rem;overflow:hidden;border:1px solid var(--line);border-radius:var(--radius);background:var(--paper-2)}.chapter-photo-feature img{width:100%;max-height:620px;object-fit:cover;border-radius:0;box-shadow:none;margin:0}.chapter-photo-feature figcaption{display:grid;gap:.2rem;padding:.9rem 1rem;font-family:Inter,ui-sans-serif,system-ui,sans-serif}.chapter-photo-feature figcaption strong{color:var(--navy)}.chapter-photo-feature figcaption span{color:var(--ink-soft);font-size:.9rem}.antarctic-feature{display:grid;grid-template-columns:1.2fr .8fr;gap:1.5rem;align-items:center;margin-bottom:3rem;padding:1rem;border:1px solid var(--line);border-radius:var(--radius);background:rgba(255,255,255,.72)}.antarctic-feature img{width:100%;max-height:560px;object-fit:cover;border-radius:18px}.antarctic-feature>div{padding:1rem}.antarctic-feature p:last-child{margin-top:1rem;color:var(--ink-soft)}.antarctic-chapters-heading{max-width:760px;margin:0 0 1.35rem}.antarctic-chapters-heading h2{margin-top:.25rem}.antarctic-grid{margin-bottom:3rem}@media(max-width:760px){.antarctic-feature{grid-template-columns:1fr}.antarctic-feature>div{padding:.5rem}}\n'''
    if '.chapter-photo-feature' not in css:
        css += extra
    else:
        css = re.sub(r'\n\.chapter-photo-feature\{.*?@media\(max-width:760px\)\{\.antarctic-feature\{grid-template-columns:1fr\}\}\n', extra, css, flags=re.S)
